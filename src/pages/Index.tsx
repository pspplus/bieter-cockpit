        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 text-center max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 animate-slide-up" style={{
              ...
              {isAuthenticated ? (
                <Button size="lg" onClick={() => navigate("/dashboard")} className="rounded-full">
                  {tGeneral("getStarted")}
                  <ChevronRight className="h-4 w-4 ml-1" />
                </Button>
              ) : (
                <Button size="lg" onClick={() => navigate("/signup")} className="rounded-full">
                  {tGeneral("auth.signup")}
                  <ChevronRight className="h-4 w-4 ml-1" />
                </Button>
              )}
        ...
        <section className="py-16 bg-tender-50 dark:bg-tender-900">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-semibold mb-4 text-bieter-blue">{t("featureHeading")}</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="tender-card dark:bg-tender-800 dark:border-tender-700 animate-scale-in" style={{
                ...
                <h3 className="text-xl font-medium mb-2 text-bieter-blue">{t("feature1Title")}</h3>
              ...
              <div className="tender-card dark:bg-tender-800 dark:border-tender-700 animate-scale-in" style={{
                ...
                <h3 className="text-xl font-medium mb-2 text-bieter-blue">{t("feature2Title")}</h3>
                <p className="text-tender-600 dark:text-tender-300">
              ...
              <div className="tender-card dark:bg-tender-800 dark:border-tender-700 animate-scale-in" style={{
                ...
                <h3 className="text-xl font-medium mb-2 text-bieter-blue">{t("feature3Title")}</h3>
                <p className="text-tender-600 dark:text-tender-300">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-tender-500 dark:text-tender-400 text-sm">
              © {new Date().getFullYear()} Bieter Cockpit. Alle Rechte vorbehalten.
            </p>
          </div>
        </div>
      </footer>
